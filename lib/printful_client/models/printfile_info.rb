...
module Printful
  ...
  class PrintfileInfo
    ...
    attr_accessor :available_placements

    attr_accessor :printfiles

    attr_accessor :variant_printfiles
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::PrintfileInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::PrintfileInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'available_placements')
        self.available_placements = attributes[:'available_placements']
      end

      if attributes.key?(:'printfiles')
        if (value = attributes[:'printfiles']).is_a?(Array)
          self.printfiles = value
        end
      end

      if attributes.key?(:'variant_printfiles')
        if (value = attributes[:'variant_printfiles']).is_a?(Array)
          self.variant_printfiles = value
        end
      end

      if attributes.key?(:'option_groups')
        if (value = attributes[:'option_groups']).is_a?(Array)
          self.option_groups = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          available_placements == o.available_placements &&
          printfiles == o.printfiles &&
          variant_printfiles == o.variant_printfiles &&
    ...
    def hash
      [product_id, available_placements, printfiles, variant_printfiles, option_groups, options].hash
    end
