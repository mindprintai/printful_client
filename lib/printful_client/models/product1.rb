...
module Printful
  ...
  class Product1
    attr_accessor :sync_product

    # Information about the Sync Variants
    attr_accessor :sync_variants
    ...
    def self.openapi_types
      {
        ...
        :'sync_variants' => :'Array<Product1SyncVariantsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::Product1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::Product1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'sync_product')
        self.sync_product = attributes[:'sync_product']
      else
        self.sync_product = nil
      end

      if attributes.key?(:'sync_variants')
        if (value = attributes[:'sync_variants']).is_a?(Array)
          self.sync_variants = value
        end
      else
        self.sync_variants = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @sync_product.nil?
        invalid_properties.push('invalid value for "sync_product", sync_product cannot be nil.')
      end

      if @sync_variants.nil?
        invalid_properties.push('invalid value for "sync_variants", sync_variants cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @sync_product.nil?
      return false if @sync_variants.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          sync_product == o.sync_product &&
          sync_variants == o.sync_variants
    end
    ...
    def hash
      [sync_product, sync_variants].hash
    end
