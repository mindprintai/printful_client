...
module Printful
  class OptionType
    ...
    attr_accessor :additional_price_breakdown
    ...
    def self.attribute_map
      {
        ...
        :'additional_price_breakdown' => :'additional_price_breakdown'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'additional_price_breakdown' => :'Hash<String, Object>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::OptionType` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::OptionType`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'additional_price_breakdown')
        if (value = attributes[:'additional_price_breakdown']).is_a?(Hash)
          self.additional_price_breakdown = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          additional_price_breakdown == o.additional_price_breakdown
    end
    ...
    def hash
      [id, title, type, values, additional_price, additional_price_breakdown].hash
    end
