...
module Printful
  ...
  class ProductTemplate
    ...
    attr_accessor :conflicting_placements
    ...
    def self.attribute_map
      {
        ...
        :'templates' => :'templates',
        :'conflicting_placements' => :'conflicting_placements'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::ProductTemplate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::ProductTemplate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'min_dpi')
        self.min_dpi = attributes[:'min_dpi']
      end

      if attributes.key?(:'variant_mapping')
        if (value = attributes[:'variant_mapping']).is_a?(Array)
          self.variant_mapping = value
        end
      end
      ...
      if attributes.key?(:'conflicting_placements')
        if (value = attributes[:'conflicting_placements']).is_a?(Array)
          self.conflicting_placements = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          version == o.version &&
          min_dpi == o.min_dpi &&
          variant_mapping == o.variant_mapping &&
          templates == o.templates &&
          conflicting_placements == o.conflicting_placements
    end
    ...
    def hash
      [version, min_dpi, variant_mapping, templates, conflicting_placements].hash
    end
