...
module Printful
  class OrderCosts
    ...
    # Retail delivery fee
    attr_accessor :retail_delivery_fee
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::OrderCosts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::OrderCosts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'digitization')
        self.digitization = attributes[:'digitization']
      end

      if attributes.key?(:'additional_fee')
        self.additional_fee = attributes[:'additional_fee']
      end

      if attributes.key?(:'fulfillment_fee')
        self.fulfillment_fee = attributes[:'fulfillment_fee']
      end

      if attributes.key?(:'retail_delivery_fee')
        self.retail_delivery_fee = attributes[:'retail_delivery_fee']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          discount == o.discount &&
          shipping == o.shipping &&
          digitization == o.digitization &&
          additional_fee == o.additional_fee &&
          fulfillment_fee == o.fulfillment_fee &&
          retail_delivery_fee == o.retail_delivery_fee &&
          tax == o.tax &&
          vat == o.vat &&
          total == o.total
    end
    ...
    def hash
      [currency, subtotal, discount, shipping, digitization, additional_fee, fulfillment_fee, retail_delivery_fee, tax, vat, total].hash
    end
