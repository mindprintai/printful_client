...
module Printful
  class TemplateByIdPlacementsInner
    attr_accessor :placement

    attr_accessor :display_name

    attr_accessor :technique_key

    attr_accessor :technique_display_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::TemplateByIdPlacementsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::TemplateByIdPlacementsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'technique_key')
        self.technique_key = attributes[:'technique_key']
      end

      if attributes.key?(:'technique_display_name')
        self.technique_display_name = attributes[:'technique_display_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          technique_key == o.technique_key &&
          technique_display_name == o.technique_display_name
    end
    ...
    def hash
      [placement, display_name, technique_key, technique_display_name].hash
    end
