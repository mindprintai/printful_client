...
module Printful
  class Variant
    ...
    attr_accessor :availability_regions
    ...
    def self.openapi_types
      {
        ...
        :'price' => :'String',
        :'in_stock' => :'Boolean',
        :'availability_regions' => :'Hash<String, Object>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::Variant` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::Variant`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'color_code')
        self.color_code = attributes[:'color_code']
      end

      if attributes.key?(:'color_code2')
        self.color_code2 = attributes[:'color_code2']
      end
      ...
      if attributes.key?(:'availability_regions')
        if (value = attributes[:'availability_regions']).is_a?(Hash)
          self.availability_regions = value
        end
      end

      if attributes.key?(:'availability_status')
        if (value = attributes[:'availability_status']).is_a?(Array)
          self.availability_status = value
        end
      end

      if attributes.key?(:'material')
        if (value = attributes[:'material']).is_a?(Array)
          self.material = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          color_code2 == o.color_code2 &&
          image == o.image &&
          price == o.price &&
          in_stock == o.in_stock &&
          availability_regions == o.availability_regions &&
    ...
    def hash
      [id, product_id, name, size, color, color_code, color_code2, image, price, in_stock, availability_regions, availability_status, material].hash
    end
