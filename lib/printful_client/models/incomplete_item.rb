...
module Printful
  ...
  class IncompleteItem
    ...
    attr_accessor :external_line_item_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::IncompleteItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::IncompleteItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'external_line_item_id')
        self.external_line_item_id = attributes[:'external_line_item_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          external_line_item_id == o.external_line_item_id
    end
    ...
    def hash
      [name, quantity, sync_variant_id, external_variant_id, external_line_item_id].hash
    end
