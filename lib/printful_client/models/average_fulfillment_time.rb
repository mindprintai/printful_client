...
module Printful
  ...
  class AverageFulfillmentTime
    ...
    attr_accessor :relative_difference
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::AverageFulfillmentTime` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::AverageFulfillmentTime`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'relative_difference')
        self.relative_difference = attributes[:'relative_difference']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          value == o.value &&
          relative_difference == o.relative_difference
    end
    ...
    def hash
      [value, relative_difference].hash
    end
