  ...
  class ProductSizeGuide
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::ProductSizeGuide` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::ProductSizeGuide`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'available_sizes')
        if (value = attributes[:'available_sizes']).is_a?(Array)
          self.available_sizes = value
        end
      else
        self.available_sizes = nil
      end

      if attributes.key?(:'size_tables')
        if (value = attributes[:'size_tables']).is_a?(Array)
          self.size_tables = value
        end
      else
        self.size_tables = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @available_sizes.nil?
        invalid_properties.push('invalid value for "available_sizes", available_sizes cannot be nil.')
      end

      if @size_tables.nil?
        invalid_properties.push('invalid value for "size_tables", size_tables cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @available_sizes.nil?
      return false if @size_tables.nil?
      true
    end
    ...
    def hash
      [product_id, available_sizes, size_tables].hash
    end
