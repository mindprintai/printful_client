...
module Printful
  class ApprovalSheetWebhookFile
    attr_accessor :confirm_hash

    attr_accessor :submitted_design

    attr_accessor :recommended_design

    attr_accessor :approval_sheet
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::ApprovalSheetWebhookFile` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::ApprovalSheetWebhookFile`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'confirm_hash')
        self.confirm_hash = attributes[:'confirm_hash']
      end

      if attributes.key?(:'submitted_design')
        self.submitted_design = attributes[:'submitted_design']
      end

      if attributes.key?(:'recommended_design')
        self.recommended_design = attributes[:'recommended_design']
      end

      if attributes.key?(:'approval_sheet')
        self.approval_sheet = attributes[:'approval_sheet']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          confirm_hash == o.confirm_hash &&
          submitted_design == o.submitted_design &&
          recommended_design == o.recommended_design &&
          approval_sheet == o.approval_sheet
    end
    ...
    def hash
      [confirm_hash, submitted_design, recommended_design, approval_sheet].hash
    end
