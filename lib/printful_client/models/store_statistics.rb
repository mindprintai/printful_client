...
module Printful
  ...
  class StoreStatistics
    ...
    attr_accessor :sales_and_costs

    # Sales and costs summary report
    attr_accessor :sales_and_costs_summary

    attr_accessor :printful_costs

    attr_accessor :profit

    attr_accessor :total_paid_orders

    # Costs by amount report
    attr_accessor :costs_by_amount

    # Costs by product report
    attr_accessor :costs_by_product

    # Costs by variant report
    attr_accessor :costs_by_variant

    attr_accessor :average_fulfillment_time
    ...
    def self.openapi_types
      {
        :'store_id' => :'Integer',
        :'currency' => :'String',
        :'sales_and_costs' => :'Array<SalesAndCostsInner>',
        :'sales_and_costs_summary' => :'Array<SalesAndCostsSummaryInner>',
        :'printful_costs' => :'PrintfulCosts',
        :'profit' => :'Profit',
        :'total_paid_orders' => :'TotalPaidOrders',
        :'costs_by_amount' => :'Array<CostsByAmountInner>',
        :'costs_by_product' => :'Array<CostsByProductInner>',
        :'costs_by_variant' => :'Array<CostsByVariantInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::StoreStatistics` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::StoreStatistics`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sales_and_costs')
        if (value = attributes[:'sales_and_costs']).is_a?(Array)
          self.sales_and_costs = value
        end
      end

      if attributes.key?(:'sales_and_costs_summary')
        if (value = attributes[:'sales_and_costs_summary']).is_a?(Array)
          self.sales_and_costs_summary = value
        end
      end

      if attributes.key?(:'printful_costs')
        self.printful_costs = attributes[:'printful_costs']
      end
      ...
      if attributes.key?(:'total_paid_orders')
        self.total_paid_orders = attributes[:'total_paid_orders']
      end

      if attributes.key?(:'costs_by_amount')
        if (value = attributes[:'costs_by_amount']).is_a?(Array)
          self.costs_by_amount = value
        end
      end

      if attributes.key?(:'costs_by_product')
        if (value = attributes[:'costs_by_product']).is_a?(Array)
          self.costs_by_product = value
        end
      end

      if attributes.key?(:'costs_by_variant')
        if (value = attributes[:'costs_by_variant']).is_a?(Array)
          self.costs_by_variant = value
        end
      end

      if attributes.key?(:'average_fulfillment_time')
        self.average_fulfillment_time = attributes[:'average_fulfillment_time']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          store_id == o.store_id &&
          currency == o.currency &&
          sales_and_costs == o.sales_and_costs &&
          sales_and_costs_summary == o.sales_and_costs_summary &&
          printful_costs == o.printful_costs &&
          profit == o.profit &&
          total_paid_orders == o.total_paid_orders &&
          costs_by_amount == o.costs_by_amount &&
          costs_by_product == o.costs_by_product &&
          costs_by_variant == o.costs_by_variant &&
          average_fulfillment_time == o.average_fulfillment_time
    end
    ...
    def hash
      [store_id, currency, sales_and_costs, sales_and_costs_summary, printful_costs, profit, total_paid_orders, costs_by_amount, costs_by_product, costs_by_variant, average_fulfillment_time].hash
    end
