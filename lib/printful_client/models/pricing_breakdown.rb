...
module Printful
  ...
  class PricingBreakdown
    ...
    attr_accessor :customer_pays

    # Printful price
    attr_accessor :printful_price
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::PricingBreakdown` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::PricingBreakdown`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'customer_pays')
        self.customer_pays = attributes[:'customer_pays']
      end

      if attributes.key?(:'printful_price')
        self.printful_price = attributes[:'printful_price']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          customer_pays == o.customer_pays &&
          printful_price == o.printful_price &&
          profit == o.profit &&
    ...
    def hash
      [customer_pays, printful_price, profit, currency_symbol].hash
    end
