  ...
  class SalesAndCostsInner
    ...
    def self.openapi_types
      {
        ...
        :'fulfillment_discount' => :'Float',
        :'sales_shipping' => :'Float',
        :'fulfillment_shipping' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::SalesAndCostsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::SalesAndCostsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sales_discount')
        self.sales_discount = attributes[:'sales_discount']
      end

      if attributes.key?(:'fulfillment_discount')
        self.fulfillment_discount = attributes[:'fulfillment_discount']
      end

      if attributes.key?(:'sales_shipping')
        self.sales_shipping = attributes[:'sales_shipping']
      end

      if attributes.key?(:'fulfillment_shipping')
        self.fulfillment_shipping = attributes[:'fulfillment_shipping']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          profit == o.profit &&
          sales_discount == o.sales_discount &&
          fulfillment_discount == o.fulfillment_discount &&
          sales_shipping == o.sales_shipping &&
          fulfillment_shipping == o.fulfillment_shipping
    end
    ...
    def hash
      [date, sales, fulfillment, profit, sales_discount, fulfillment_discount, sales_shipping, fulfillment_shipping].hash
    end
