  ...
  class CreateGenerationTask
    ...
    def self.openapi_types
      {
        ...
        :'format' => :'String',
        :'width' => :'Integer',
        :'product_options' => :'Hash<String, Object>',
        :'option_groups' => :'Hash<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::CreateGenerationTask` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::CreateGenerationTask`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'product_options')
        if (value = attributes[:'product_options']).is_a?(Hash)
    ...
    def valid?
      ...
      format_validator = EnumAttributeValidator.new('String', ["jpg", "png"])
    ...
    def format=(format)
      validator = EnumAttributeValidator.new('String', ["jpg", "png"])
    ...
    def hash
      [variant_ids, format, width, product_options, option_groups, options, files, product_template_id].hash
    end
