...
module Printful
  class ItemFilesInnerAllOfPosition
    ...
    attr_accessor :limit_to_print_area
    ...
    def self.attribute_map
      {
        ...
        :'top' => :'top',
        :'left' => :'left',
        :'limit_to_print_area' => :'limit_to_print_area'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::ItemFilesInnerAllOfPosition` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::ItemFilesInnerAllOfPosition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'area_width')
        self.area_width = attributes[:'area_width']
      end

      if attributes.key?(:'area_height')
        self.area_height = attributes[:'area_height']
      end
      ...
      if attributes.key?(:'limit_to_print_area')
        self.limit_to_print_area = attributes[:'limit_to_print_area']
      else
        self.limit_to_print_area = true
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          area_width == o.area_width &&
          area_height == o.area_height &&
          width == o.width &&
          height == o.height &&
          top == o.top &&
          left == o.left &&
          limit_to_print_area == o.limit_to_print_area
    end
    ...
    def hash
      [area_width, area_height, width, height, top, left, limit_to_print_area].hash
    end
