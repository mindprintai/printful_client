...
module Printful
  ...
  class TemplateById
    ...
    attr_accessor :available_variant_ids

    attr_accessor :option_data

    attr_accessor :colors

    attr_accessor :sizes

    attr_accessor :mockup_file_url
    ...
    attr_accessor :placement_option_data
    ...
    def self.attribute_map
      {
        ...
        :'colors' => :'colors',
        :'sizes' => :'sizes',
        :'mockup_file_url' => :'mockup_file_url',
        :'placements' => :'placements',
        :'created_at' => :'created_at',
        :'updated_at' => :'updated_at',
        :'placement_option_data' => :'placement_option_data'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'title' => :'String',
        :'available_variant_ids' => :'Array<Integer>',
        :'option_data' => :'Array<TemplateByIdOptionDataInner>',
        :'colors' => :'Array<TemplateByIdColorsInner>',
        :'sizes' => :'Array<String>',
        :'mockup_file_url' => :'String',
        :'placements' => :'Array<TemplateByIdPlacementsInner>',
        :'created_at' => :'Integer',
        :'updated_at' => :'Integer',
        :'placement_option_data' => :'Array<TemplateByIdPlacementOptionDataInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Printful::TemplateById` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Printful::TemplateById`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'available_variant_ids')
        if (value = attributes[:'available_variant_ids']).is_a?(Array)
          self.available_variant_ids = value
        end
      end

      if attributes.key?(:'option_data')
        if (value = attributes[:'option_data']).is_a?(Array)
      ...
      if attributes.key?(:'mockup_file_url')
        self.mockup_file_url = attributes[:'mockup_file_url']
      end
      ...
      if attributes.key?(:'placement_option_data')
        if (value = attributes[:'placement_option_data']).is_a?(Array)
          self.placement_option_data = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          title == o.title &&
          available_variant_ids == o.available_variant_ids &&
          option_data == o.option_data &&
          colors == o.colors &&
          sizes == o.sizes &&
          mockup_file_url == o.mockup_file_url &&
          placements == o.placements &&
          created_at == o.created_at &&
          updated_at == o.updated_at &&
          placement_option_data == o.placement_option_data
    end
    ...
    def hash
      [id, product_id, external_product_id, title, available_variant_ids, option_data, colors, sizes, mockup_file_url, placements, created_at, updated_at, placement_option_data].hash
    end
