  ...
  class OAuthAPIClient
    ...
    def get_scopes_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuthAPIClient.get_scopes ...'
      end
      # resource path
      local_var_path = '/oauth/scopes'
      ...
      new_options = opts.merge(
        :operation => :"OAuthAPIClient.get_scopes",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OAuthAPIClient#get_scopes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
