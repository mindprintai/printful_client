...
# Unit tests for Printful::GetStores200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetStores200Response do
  let(:instance) { Printful::GetStores200Response.new }

  describe 'test an instance of GetStores200Response' do
    it 'should create an instance of GetStores200Response' do
      expect(instance).to be_instance_of(Printful::GetStores200Response)
    end
  end
