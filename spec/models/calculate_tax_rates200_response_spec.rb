...
# Unit tests for Printful::CalculateTaxRates200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CalculateTaxRates200Response do
  let(:instance) { Printful::CalculateTaxRates200Response.new }

  describe 'test an instance of CalculateTaxRates200Response' do
    it 'should create an instance of CalculateTaxRates200Response' do
      expect(instance).to be_instance_of(Printful::CalculateTaxRates200Response)
    end
  end
