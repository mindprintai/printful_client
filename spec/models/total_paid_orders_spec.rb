...
# Unit tests for Printful::TotalPaidOrders
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TotalPaidOrders do
  let(:instance) { Printful::TotalPaidOrders.new }

  describe 'test an instance of TotalPaidOrders' do
    it 'should create an instance of TotalPaidOrders' do
      expect(instance).to be_instance_of(Printful::TotalPaidOrders)
    end
  end
