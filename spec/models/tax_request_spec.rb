...
# Unit tests for Printful::TaxRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TaxRequest do
  let(:instance) { Printful::TaxRequest.new }

  describe 'test an instance of TaxRequest' do
    it 'should create an instance of TaxRequest' do
      expect(instance).to be_instance_of(Printful::TaxRequest)
    end
  end
