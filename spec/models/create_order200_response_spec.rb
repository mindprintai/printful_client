...
# Unit tests for Printful::CreateOrder200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CreateOrder200Response do
  let(:instance) { Printful::CreateOrder200Response.new }

  describe 'test an instance of CreateOrder200Response' do
    it 'should create an instance of CreateOrder200Response' do
      expect(instance).to be_instance_of(Printful::CreateOrder200Response)
    end
  end
