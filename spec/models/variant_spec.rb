...
# Unit tests for Printful::Variant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Variant do
  let(:instance) { Printful::Variant.new }

  describe 'test an instance of Variant' do
    it 'should create an instance of Variant' do
      expect(instance).to be_instance_of(Printful::Variant)
    end
  end
  ...
  describe 'test attribute "color_code2"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "availability_regions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
