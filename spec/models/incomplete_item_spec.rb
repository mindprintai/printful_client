...
# Unit tests for Printful::IncompleteItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::IncompleteItem do
  let(:instance) { Printful::IncompleteItem.new }

  describe 'test an instance of IncompleteItem' do
    it 'should create an instance of IncompleteItem' do
      expect(instance).to be_instance_of(Printful::IncompleteItem)
    end
  end
  ...
  describe 'test attribute "sync_variant_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "external_variant_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "external_line_item_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
