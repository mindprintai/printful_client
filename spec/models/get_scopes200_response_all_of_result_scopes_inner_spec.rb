...
# Unit tests for Printful::GetScopes200ResponseAllOfResultScopesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetScopes200ResponseAllOfResultScopesInner do
  let(:instance) { Printful::GetScopes200ResponseAllOfResultScopesInner.new }

  describe 'test an instance of GetScopes200ResponseAllOfResultScopesInner' do
    it 'should create an instance of GetScopes200ResponseAllOfResultScopesInner' do
      expect(instance).to be_instance_of(Printful::GetScopes200ResponseAllOfResultScopesInner)
    end
  end
