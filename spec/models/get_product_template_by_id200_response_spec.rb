...
# Unit tests for Printful::GetProductTemplateById200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetProductTemplateById200Response do
  let(:instance) { Printful::GetProductTemplateById200Response.new }

  describe 'test an instance of GetProductTemplateById200Response' do
    it 'should create an instance of GetProductTemplateById200Response' do
      expect(instance).to be_instance_of(Printful::GetProductTemplateById200Response)
    end
  end
