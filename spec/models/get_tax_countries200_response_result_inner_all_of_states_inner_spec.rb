...
# Unit tests for Printful::GetTaxCountries200ResponseResultInnerAllOfStatesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetTaxCountries200ResponseResultInnerAllOfStatesInner do
  let(:instance) { Printful::GetTaxCountries200ResponseResultInnerAllOfStatesInner.new }

  describe 'test an instance of GetTaxCountries200ResponseResultInnerAllOfStatesInner' do
    it 'should create an instance of GetTaxCountries200ResponseResultInnerAllOfStatesInner' do
      expect(instance).to be_instance_of(Printful::GetTaxCountries200ResponseResultInnerAllOfStatesInner)
    end
  end
  describe 'test attribute "shipping_taxable"' do
    it 'should work' do
