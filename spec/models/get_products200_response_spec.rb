...
# Unit tests for Printful::GetProducts200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetProducts200Response do
  let(:instance) { Printful::GetProducts200Response.new }

  describe 'test an instance of GetProducts200Response' do
    it 'should create an instance of GetProducts200Response' do
      expect(instance).to be_instance_of(Printful::GetProducts200Response)
    end
  end
