...
# Unit tests for Printful::PrintfulCosts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::PrintfulCosts do
  let(:instance) { Printful::PrintfulCosts.new }

  describe 'test an instance of PrintfulCosts' do
    it 'should create an instance of PrintfulCosts' do
      expect(instance).to be_instance_of(Printful::PrintfulCosts)
    end
  end
