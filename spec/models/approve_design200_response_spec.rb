...
# Unit tests for Printful::ApproveDesign200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ApproveDesign200Response do
  let(:instance) { Printful::ApproveDesign200Response.new }

  describe 'test an instance of ApproveDesign200Response' do
    it 'should create an instance of ApproveDesign200Response' do
      expect(instance).to be_instance_of(Printful::ApproveDesign200Response)
    end
  end
