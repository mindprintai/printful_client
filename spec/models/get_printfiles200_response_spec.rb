...
# Unit tests for Printful::GetPrintfiles200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetPrintfiles200Response do
  let(:instance) { Printful::GetPrintfiles200Response.new }

  describe 'test an instance of GetPrintfiles200Response' do
    it 'should create an instance of GetPrintfiles200Response' do
      expect(instance).to be_instance_of(Printful::GetPrintfiles200Response)
    end
  end
