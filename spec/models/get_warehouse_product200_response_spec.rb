...
# Unit tests for Printful::GetWarehouseProduct200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetWarehouseProduct200Response do
  let(:instance) { Printful::GetWarehouseProduct200Response.new }

  describe 'test an instance of GetWarehouseProduct200Response' do
    it 'should create an instance of GetWarehouseProduct200Response' do
      expect(instance).to be_instance_of(Printful::GetWarehouseProduct200Response)
    end
  end
