...
# Unit tests for Printful::GetSyncProductById200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetSyncProductById200Response do
  let(:instance) { Printful::GetSyncProductById200Response.new }

  describe 'test an instance of GetSyncProductById200Response' do
    it 'should create an instance of GetSyncProductById200Response' do
      expect(instance).to be_instance_of(Printful::GetSyncProductById200Response)
    end
  end
