...
# Unit tests for Printful::Response200
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Response200 do
  let(:instance) { Printful::Response200.new }

  describe 'test an instance of Response200' do
    it 'should create an instance of Response200' do
      expect(instance).to be_instance_of(Printful::Response200)
    end
  end
