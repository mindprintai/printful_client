...
# Unit tests for Printful::GenerationTaskFilePosition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GenerationTaskFilePosition do
  let(:instance) { Printful::GenerationTaskFilePosition.new }

  describe 'test an instance of GenerationTaskFilePosition' do
    it 'should create an instance of GenerationTaskFilePosition' do
      expect(instance).to be_instance_of(Printful::GenerationTaskFilePosition)
    end
  end
