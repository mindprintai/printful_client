...
# Unit tests for Printful::GetOrders200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetOrders200Response do
  let(:instance) { Printful::GetOrders200Response.new }

  describe 'test an instance of GetOrders200Response' do
    it 'should create an instance of GetOrders200Response' do
      expect(instance).to be_instance_of(Printful::GetOrders200Response)
    end
  end
