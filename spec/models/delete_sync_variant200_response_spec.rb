...
# Unit tests for Printful::DeleteSyncVariant200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::DeleteSyncVariant200Response do
  let(:instance) { Printful::DeleteSyncVariant200Response.new }

  describe 'test an instance of DeleteSyncVariant200Response' do
    it 'should create an instance of DeleteSyncVariant200Response' do
      expect(instance).to be_instance_of(Printful::DeleteSyncVariant200Response)
    end
  end
