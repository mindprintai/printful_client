...
# Unit tests for Printful::SyncProductInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SyncProductInfo do
  let(:instance) { Printful::SyncProductInfo.new }

  describe 'test an instance of SyncProductInfo' do
    it 'should create an instance of SyncProductInfo' do
      expect(instance).to be_instance_of(Printful::SyncProductInfo)
    end
  end
