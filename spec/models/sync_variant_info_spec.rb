...
# Unit tests for Printful::SyncVariantInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SyncVariantInfo do
  let(:instance) { Printful::SyncVariantInfo.new }

  describe 'test an instance of SyncVariantInfo' do
    it 'should create an instance of SyncVariantInfo' do
      expect(instance).to be_instance_of(Printful::SyncVariantInfo)
    end
  end
  describe 'test attribute "sync_variant"' do
    it 'should work' do
