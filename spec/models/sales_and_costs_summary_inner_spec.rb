...
# Unit tests for Printful::SalesAndCostsSummaryInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SalesAndCostsSummaryInner do
  let(:instance) { Printful::SalesAndCostsSummaryInner.new }

  describe 'test an instance of SalesAndCostsSummaryInner' do
    it 'should create an instance of SalesAndCostsSummaryInner' do
      expect(instance).to be_instance_of(Printful::SalesAndCostsSummaryInner)
    end
  end
