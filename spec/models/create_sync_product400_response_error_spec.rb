...
# Unit tests for Printful::CreateSyncProduct400ResponseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CreateSyncProduct400ResponseError do
  let(:instance) { Printful::CreateSyncProduct400ResponseError.new }

  describe 'test an instance of CreateSyncProduct400ResponseError' do
    it 'should create an instance of CreateSyncProduct400ResponseError' do
      expect(instance).to be_instance_of(Printful::CreateSyncProduct400ResponseError)
    end
  end
