...
# Unit tests for Printful::GenerationTaskMockup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GenerationTaskMockup do
  let(:instance) { Printful::GenerationTaskMockup.new }

  describe 'test an instance of GenerationTaskMockup' do
    it 'should create an instance of GenerationTaskMockup' do
      expect(instance).to be_instance_of(Printful::GenerationTaskMockup)
    end
  end
  ...
  describe 'test attribute "mockup_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
