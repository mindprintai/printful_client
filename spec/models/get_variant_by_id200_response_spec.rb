...
# Unit tests for Printful::GetVariantById200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetVariantById200Response do
  let(:instance) { Printful::GetVariantById200Response.new }

  describe 'test an instance of GetVariantById200Response' do
    it 'should create an instance of GetVariantById200Response' do
      expect(instance).to be_instance_of(Printful::GetVariantById200Response)
    end
  end
