...
# Unit tests for Printful::ApprovalSheetWebhookFile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ApprovalSheetWebhookFile do
  let(:instance) { Printful::ApprovalSheetWebhookFile.new }

  describe 'test an instance of ApprovalSheetWebhookFile' do
    it 'should create an instance of ApprovalSheetWebhookFile' do
      expect(instance).to be_instance_of(Printful::ApprovalSheetWebhookFile)
    end
  end
  describe 'test attribute "confirm_hash"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "submitted_design"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "recommended_design"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "approval_sheet"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
