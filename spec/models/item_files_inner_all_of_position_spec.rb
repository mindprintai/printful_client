...
# Unit tests for Printful::ItemFilesInnerAllOfPosition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ItemFilesInnerAllOfPosition do
  let(:instance) { Printful::ItemFilesInnerAllOfPosition.new }

  describe 'test an instance of ItemFilesInnerAllOfPosition' do
    it 'should create an instance of ItemFilesInnerAllOfPosition' do
      expect(instance).to be_instance_of(Printful::ItemFilesInnerAllOfPosition)
    end
  end
  describe 'test attribute "area_width"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "area_height"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "limit_to_print_area"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
