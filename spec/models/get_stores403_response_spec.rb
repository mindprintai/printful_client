...
# Unit tests for Printful::GetStores403Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetStores403Response do
  let(:instance) { Printful::GetStores403Response.new }

  describe 'test an instance of GetStores403Response' do
    it 'should create an instance of GetStores403Response' do
      expect(instance).to be_instance_of(Printful::GetStores403Response)
    end
  end
