...
# Unit tests for Printful::ItemOption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ItemOption do
  let(:instance) { Printful::ItemOption.new }

  describe 'test an instance of ItemOption' do
    it 'should create an instance of ItemOption' do
      expect(instance).to be_instance_of(Printful::ItemOption)
    end
  end
