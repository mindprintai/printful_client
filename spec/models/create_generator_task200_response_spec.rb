...
# Unit tests for Printful::CreateGeneratorTask200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CreateGeneratorTask200Response do
  let(:instance) { Printful::CreateGeneratorTask200Response.new }

  describe 'test an instance of CreateGeneratorTask200Response' do
    it 'should create an instance of CreateGeneratorTask200Response' do
      expect(instance).to be_instance_of(Printful::CreateGeneratorTask200Response)
    end
  end
