...
# Unit tests for Printful::ChangePackingSlip200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ChangePackingSlip200Response do
  let(:instance) { Printful::ChangePackingSlip200Response.new }

  describe 'test an instance of ChangePackingSlip200Response' do
    it 'should create an instance of ChangePackingSlip200Response' do
      expect(instance).to be_instance_of(Printful::ChangePackingSlip200Response)
    end
  end
