...
# Unit tests for Printful::ProductTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ProductTemplate do
  let(:instance) { Printful::ProductTemplate.new }

  describe 'test an instance of ProductTemplate' do
    it 'should create an instance of ProductTemplate' do
      expect(instance).to be_instance_of(Printful::ProductTemplate)
    end
  end
  ...
  describe 'test attribute "min_dpi"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "variant_mapping"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "conflicting_placements"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
