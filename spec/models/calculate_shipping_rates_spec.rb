...
# Unit tests for Printful::CalculateShippingRates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CalculateShippingRates do
  let(:instance) { Printful::CalculateShippingRates.new }

  describe 'test an instance of CalculateShippingRates' do
    it 'should create an instance of CalculateShippingRates' do
      expect(instance).to be_instance_of(Printful::CalculateShippingRates)
    end
  end
