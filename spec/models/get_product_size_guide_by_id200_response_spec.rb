...
# Unit tests for Printful::GetProductSizeGuideById200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetProductSizeGuideById200Response do
  let(:instance) { Printful::GetProductSizeGuideById200Response.new }

  describe 'test an instance of GetProductSizeGuideById200Response' do
    it 'should create an instance of GetProductSizeGuideById200Response' do
      expect(instance).to be_instance_of(Printful::GetProductSizeGuideById200Response)
    end
  end
