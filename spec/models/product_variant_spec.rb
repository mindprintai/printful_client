...
# Unit tests for Printful::ProductVariant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ProductVariant do
  let(:instance) { Printful::ProductVariant.new }

  describe 'test an instance of ProductVariant' do
    it 'should create an instance of ProductVariant' do
      expect(instance).to be_instance_of(Printful::ProductVariant)
    end
  end
