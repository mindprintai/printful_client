...
# Unit tests for Printful::Product1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Product1 do
  let(:instance) { Printful::Product1.new }

  describe 'test an instance of Product1' do
    it 'should create an instance of Product1' do
      expect(instance).to be_instance_of(Printful::Product1)
    end
  end
