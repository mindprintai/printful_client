...
# Unit tests for Printful::TemplateVariantMappingItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TemplateVariantMappingItem do
  let(:instance) { Printful::TemplateVariantMappingItem.new }

  describe 'test an instance of TemplateVariantMappingItem' do
    it 'should create an instance of TemplateVariantMappingItem' do
      expect(instance).to be_instance_of(Printful::TemplateVariantMappingItem)
    end
  end
