...
# Unit tests for Printful::GetScopes200ResponseAllOfResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetScopes200ResponseAllOfResult do
  let(:instance) { Printful::GetScopes200ResponseAllOfResult.new }

  describe 'test an instance of GetScopes200ResponseAllOfResult' do
    it 'should create an instance of GetScopes200ResponseAllOfResult' do
      expect(instance).to be_instance_of(Printful::GetScopes200ResponseAllOfResult)
    end
  end
