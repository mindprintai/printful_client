...
# Unit tests for Printful::GetStoreSyncVariantById200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetStoreSyncVariantById200Response do
  let(:instance) { Printful::GetStoreSyncVariantById200Response.new }

  describe 'test an instance of GetStoreSyncVariantById200Response' do
    it 'should create an instance of GetStoreSyncVariantById200Response' do
      expect(instance).to be_instance_of(Printful::GetStoreSyncVariantById200Response)
    end
  end
