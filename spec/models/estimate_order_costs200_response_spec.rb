...
# Unit tests for Printful::EstimateOrderCosts200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::EstimateOrderCosts200Response do
  let(:instance) { Printful::EstimateOrderCosts200Response.new }

  describe 'test an instance of EstimateOrderCosts200Response' do
    it 'should create an instance of EstimateOrderCosts200Response' do
      expect(instance).to be_instance_of(Printful::EstimateOrderCosts200Response)
    end
  end
