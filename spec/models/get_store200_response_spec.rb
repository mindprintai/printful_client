...
# Unit tests for Printful::GetStore200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetStore200Response do
  let(:instance) { Printful::GetStore200Response.new }

  describe 'test an instance of GetStore200Response' do
    it 'should create an instance of GetStore200Response' do
      expect(instance).to be_instance_of(Printful::GetStore200Response)
    end
  end
