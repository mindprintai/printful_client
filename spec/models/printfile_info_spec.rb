...
# Unit tests for Printful::PrintfileInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::PrintfileInfo do
  let(:instance) { Printful::PrintfileInfo.new }

  describe 'test an instance of PrintfileInfo' do
    it 'should create an instance of PrintfileInfo' do
      expect(instance).to be_instance_of(Printful::PrintfileInfo)
    end
  end
  ...
  describe 'test attribute "available_placements"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "printfiles"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "variant_printfiles"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
