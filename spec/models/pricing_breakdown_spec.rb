...
# Unit tests for Printful::PricingBreakdown
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::PricingBreakdown do
  let(:instance) { Printful::PricingBreakdown.new }

  describe 'test an instance of PricingBreakdown' do
    it 'should create an instance of PricingBreakdown' do
      expect(instance).to be_instance_of(Printful::PricingBreakdown)
    end
  end
  describe 'test attribute "customer_pays"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "printful_price"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
