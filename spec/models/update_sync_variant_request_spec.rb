...
# Unit tests for Printful::UpdateSyncVariantRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::UpdateSyncVariantRequest do
  let(:instance) { Printful::UpdateSyncVariantRequest.new }

  describe 'test an instance of UpdateSyncVariantRequest' do
    it 'should create an instance of UpdateSyncVariantRequest' do
      expect(instance).to be_instance_of(Printful::UpdateSyncVariantRequest)
    end
  end
