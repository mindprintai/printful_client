...
# Unit tests for Printful::GetStores403ResponseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetStores403ResponseError do
  let(:instance) { Printful::GetStores403ResponseError.new }

  describe 'test an instance of GetStores403ResponseError' do
    it 'should create an instance of GetStores403ResponseError' do
      expect(instance).to be_instance_of(Printful::GetStores403ResponseError)
    end
  end
