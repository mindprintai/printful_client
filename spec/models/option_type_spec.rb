...
# Unit tests for Printful::OptionType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::OptionType do
  let(:instance) { Printful::OptionType.new }

  describe 'test an instance of OptionType' do
    it 'should create an instance of OptionType' do
      expect(instance).to be_instance_of(Printful::OptionType)
    end
  end
  ...
  describe 'test attribute "additional_price_breakdown"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
