...
# Unit tests for Printful::TaxAddressInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TaxAddressInfo do
  let(:instance) { Printful::TaxAddressInfo.new }

  describe 'test an instance of TaxAddressInfo' do
    it 'should create an instance of TaxAddressInfo' do
      expect(instance).to be_instance_of(Printful::TaxAddressInfo)
    end
  end
