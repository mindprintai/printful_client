...
# Unit tests for Printful::TemplateByIdOptionDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TemplateByIdOptionDataInner do
  let(:instance) { Printful::TemplateByIdOptionDataInner.new }

  describe 'test an instance of TemplateByIdOptionDataInner' do
    it 'should create an instance of TemplateByIdOptionDataInner' do
      expect(instance).to be_instance_of(Printful::TemplateByIdOptionDataInner)
    end
  end
