...
# Unit tests for Printful::TemplateByIdColorsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TemplateByIdColorsInner do
  let(:instance) { Printful::TemplateByIdColorsInner.new }

  describe 'test an instance of TemplateByIdColorsInner' do
    it 'should create an instance of TemplateByIdColorsInner' do
      expect(instance).to be_instance_of(Printful::TemplateByIdColorsInner)
    end
  end
  ...
  describe 'test attribute "color_codes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
