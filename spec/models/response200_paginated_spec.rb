...
# Unit tests for Printful::Response200Paginated
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Response200Paginated do
  let(:instance) { Printful::Response200Paginated.new }

  describe 'test an instance of Response200Paginated' do
    it 'should create an instance of Response200Paginated' do
      expect(instance).to be_instance_of(Printful::Response200Paginated)
    end
  end
