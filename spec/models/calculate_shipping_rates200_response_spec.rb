...
# Unit tests for Printful::CalculateShippingRates200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CalculateShippingRates200Response do
  let(:instance) { Printful::CalculateShippingRates200Response.new }

  describe 'test an instance of CalculateShippingRates200Response' do
    it 'should create an instance of CalculateShippingRates200Response' do
      expect(instance).to be_instance_of(Printful::CalculateShippingRates200Response)
    end
  end
