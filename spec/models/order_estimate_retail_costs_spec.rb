...
# Unit tests for Printful::OrderEstimateRetailCosts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::OrderEstimateRetailCosts do
  let(:instance) { Printful::OrderEstimateRetailCosts.new }

  describe 'test an instance of OrderEstimateRetailCosts' do
    it 'should create an instance of OrderEstimateRetailCosts' do
      expect(instance).to be_instance_of(Printful::OrderEstimateRetailCosts)
    end
  end
