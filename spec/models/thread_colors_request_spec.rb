...
# Unit tests for Printful::ThreadColorsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ThreadColorsRequest do
  let(:instance) { Printful::ThreadColorsRequest.new }

  describe 'test an instance of ThreadColorsRequest' do
    it 'should create an instance of ThreadColorsRequest' do
      expect(instance).to be_instance_of(Printful::ThreadColorsRequest)
    end
  end
