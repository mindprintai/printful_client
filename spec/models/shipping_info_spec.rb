...
# Unit tests for Printful::ShippingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ShippingInfo do
  let(:instance) { Printful::ShippingInfo.new }

  describe 'test an instance of ShippingInfo' do
    it 'should create an instance of ShippingInfo' do
      expect(instance).to be_instance_of(Printful::ShippingInfo)
    end
  end
