...
# Unit tests for Printful::SyncProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SyncProduct do
  let(:instance) { Printful::SyncProduct.new }

  describe 'test an instance of SyncProduct' do
    it 'should create an instance of SyncProduct' do
      expect(instance).to be_instance_of(Printful::SyncProduct)
    end
  end
