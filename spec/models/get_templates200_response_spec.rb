...
# Unit tests for Printful::GetTemplates200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetTemplates200Response do
  let(:instance) { Printful::GetTemplates200Response.new }

  describe 'test an instance of GetTemplates200Response' do
    it 'should create an instance of GetTemplates200Response' do
      expect(instance).to be_instance_of(Printful::GetTemplates200Response)
    end
  end
