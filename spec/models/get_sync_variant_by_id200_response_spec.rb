...
# Unit tests for Printful::GetSyncVariantById200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetSyncVariantById200Response do
  let(:instance) { Printful::GetSyncVariantById200Response.new }

  describe 'test an instance of GetSyncVariantById200Response' do
    it 'should create an instance of GetSyncVariantById200Response' do
      expect(instance).to be_instance_of(Printful::GetSyncVariantById200Response)
    end
  end
