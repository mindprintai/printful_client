...
# Unit tests for Printful::GetProducts401ResponseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetProducts401ResponseError do
  let(:instance) { Printful::GetProducts401ResponseError.new }

  describe 'test an instance of GetProducts401ResponseError' do
    it 'should create an instance of GetProducts401ResponseError' do
      expect(instance).to be_instance_of(Printful::GetProducts401ResponseError)
    end
  end
