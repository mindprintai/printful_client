...
# Unit tests for Printful::SyncVariantProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SyncVariantProduct do
  let(:instance) { Printful::SyncVariantProduct.new }

  describe 'test an instance of SyncVariantProduct' do
    it 'should create an instance of SyncVariantProduct' do
      expect(instance).to be_instance_of(Printful::SyncVariantProduct)
    end
  end
