...
# Unit tests for Printful::AverageFulfillmentTime
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::AverageFulfillmentTime do
  let(:instance) { Printful::AverageFulfillmentTime.new }

  describe 'test an instance of AverageFulfillmentTime' do
    it 'should create an instance of AverageFulfillmentTime' do
      expect(instance).to be_instance_of(Printful::AverageFulfillmentTime)
    end
  end
  ...
  describe 'test attribute "relative_difference"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
