...
# Unit tests for Printful::Product1SyncVariantsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Product1SyncVariantsInner do
  let(:instance) { Printful::Product1SyncVariantsInner.new }

  describe 'test an instance of Product1SyncVariantsInner' do
    it 'should create an instance of Product1SyncVariantsInner' do
      expect(instance).to be_instance_of(Printful::Product1SyncVariantsInner)
    end
  end
