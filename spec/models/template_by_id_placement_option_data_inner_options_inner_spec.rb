...
# Unit tests for Printful::TemplateByIdPlacementOptionDataInnerOptionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TemplateByIdPlacementOptionDataInnerOptionsInner do
  let(:instance) { Printful::TemplateByIdPlacementOptionDataInnerOptionsInner.new }

  describe 'test an instance of TemplateByIdPlacementOptionDataInnerOptionsInner' do
    it 'should create an instance of TemplateByIdPlacementOptionDataInnerOptionsInner' do
      expect(instance).to be_instance_of(Printful::TemplateByIdPlacementOptionDataInnerOptionsInner)
    end
  end
