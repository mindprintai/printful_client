...
# Unit tests for Printful::Templates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Templates do
  let(:instance) { Printful::Templates.new }

  describe 'test an instance of Templates' do
    it 'should create an instance of Templates' do
      expect(instance).to be_instance_of(Printful::Templates)
    end
  end
