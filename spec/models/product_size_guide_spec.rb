...
# Unit tests for Printful::ProductSizeGuide
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ProductSizeGuide do
  let(:instance) { Printful::ProductSizeGuide.new }

  describe 'test an instance of ProductSizeGuide' do
    it 'should create an instance of ProductSizeGuide' do
      expect(instance).to be_instance_of(Printful::ProductSizeGuide)
    end
  end
  ...
  describe 'test attribute "size_tables"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
