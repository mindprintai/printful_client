...
# Unit tests for Printful::AvailableTechnique
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::AvailableTechnique do
  let(:instance) { Printful::AvailableTechnique.new }

  describe 'test an instance of AvailableTechnique' do
    it 'should create an instance of AvailableTechnique' do
      expect(instance).to be_instance_of(Printful::AvailableTechnique)
    end
  end
