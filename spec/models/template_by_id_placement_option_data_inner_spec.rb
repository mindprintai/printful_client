...
# Unit tests for Printful::TemplateByIdPlacementOptionDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TemplateByIdPlacementOptionDataInner do
  let(:instance) { Printful::TemplateByIdPlacementOptionDataInner.new }

  describe 'test an instance of TemplateByIdPlacementOptionDataInner' do
    it 'should create an instance of TemplateByIdPlacementOptionDataInner' do
      expect(instance).to be_instance_of(Printful::TemplateByIdPlacementOptionDataInner)
    end
  end
