...
# Unit tests for Printful::Material
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Material do
  let(:instance) { Printful::Material.new }

  describe 'test an instance of Material' do
    it 'should create an instance of Material' do
      expect(instance).to be_instance_of(Printful::Material)
    end
  end
