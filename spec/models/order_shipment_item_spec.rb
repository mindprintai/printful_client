...
# Unit tests for Printful::OrderShipmentItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::OrderShipmentItem do
  let(:instance) { Printful::OrderShipmentItem.new }

  describe 'test an instance of OrderShipmentItem' do
    it 'should create an instance of OrderShipmentItem' do
      expect(instance).to be_instance_of(Printful::OrderShipmentItem)
    end
  end
  ...
  describe 'test attribute "picked"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', [0, 1])
      # validator.allowable_values.each do |value|
      #   expect { instance.picked = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "printed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', [0, 1])
      # validator.allowable_values.each do |value|
      #   expect { instance.printed = value }.not_to raise_error
      # end
    end
  end
