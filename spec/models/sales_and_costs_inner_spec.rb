...
# Unit tests for Printful::SalesAndCostsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SalesAndCostsInner do
  let(:instance) { Printful::SalesAndCostsInner.new }

  describe 'test an instance of SalesAndCostsInner' do
    it 'should create an instance of SalesAndCostsInner' do
      expect(instance).to be_instance_of(Printful::SalesAndCostsInner)
    end
  end
  ...
  describe 'test attribute "sales_discount"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "fulfillment_discount"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "sales_shipping"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "fulfillment_shipping"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
