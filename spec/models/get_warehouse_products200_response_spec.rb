...
# Unit tests for Printful::GetWarehouseProducts200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetWarehouseProducts200Response do
  let(:instance) { Printful::GetWarehouseProducts200Response.new }

  describe 'test an instance of GetWarehouseProducts200Response' do
    it 'should create an instance of GetWarehouseProducts200Response' do
      expect(instance).to be_instance_of(Printful::GetWarehouseProducts200Response)
    end
  end
