...
# Unit tests for Printful::FileOption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::FileOption do
  let(:instance) { Printful::FileOption.new }

  describe 'test an instance of FileOption' do
    it 'should create an instance of FileOption' do
      expect(instance).to be_instance_of(Printful::FileOption)
    end
  end
