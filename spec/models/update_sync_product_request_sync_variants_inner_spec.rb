...
# Unit tests for Printful::UpdateSyncProductRequestSyncVariantsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::UpdateSyncProductRequestSyncVariantsInner do
  let(:instance) { Printful::UpdateSyncProductRequestSyncVariantsInner.new }

  describe 'test an instance of UpdateSyncProductRequestSyncVariantsInner' do
    it 'should create an instance of UpdateSyncProductRequestSyncVariantsInner' do
      expect(instance).to be_instance_of(Printful::UpdateSyncProductRequestSyncVariantsInner)
    end
  end
  ...
  describe 'test attribute "sync_product_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "main_category_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "warehouse_product_variant_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
