...
# Unit tests for Printful::CreateWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CreateWebhookRequest do
  let(:instance) { Printful::CreateWebhookRequest.new }

  describe 'test an instance of CreateWebhookRequest' do
    it 'should create an instance of CreateWebhookRequest' do
      expect(instance).to be_instance_of(Printful::CreateWebhookRequest)
    end
  end
