...
# Unit tests for Printful::CostsByVariantInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CostsByVariantInner do
  let(:instance) { Printful::CostsByVariantInner.new }

  describe 'test an instance of CostsByVariantInner' do
    it 'should create an instance of CostsByVariantInner' do
      expect(instance).to be_instance_of(Printful::CostsByVariantInner)
    end
  end
