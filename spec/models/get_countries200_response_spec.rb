...
# Unit tests for Printful::GetCountries200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetCountries200Response do
  let(:instance) { Printful::GetCountries200Response.new }

  describe 'test an instance of GetCountries200Response' do
    it 'should create an instance of GetCountries200Response' do
      expect(instance).to be_instance_of(Printful::GetCountries200Response)
    end
  end
