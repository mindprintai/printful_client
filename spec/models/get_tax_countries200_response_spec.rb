...
# Unit tests for Printful::GetTaxCountries200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetTaxCountries200Response do
  let(:instance) { Printful::GetTaxCountries200Response.new }

  describe 'test an instance of GetTaxCountries200Response' do
    it 'should create an instance of GetTaxCountries200Response' do
      expect(instance).to be_instance_of(Printful::GetTaxCountries200Response)
    end
  end
