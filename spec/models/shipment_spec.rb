...
# Unit tests for Printful::Shipment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Shipment do
  let(:instance) { Printful::Shipment.new }

  describe 'test an instance of Shipment' do
    it 'should create an instance of Shipment' do
      expect(instance).to be_instance_of(Printful::Shipment)
    end
  end
  ...
  describe 'test attribute "reshipment"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
