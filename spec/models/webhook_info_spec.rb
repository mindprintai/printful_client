...
# Unit tests for Printful::WebhookInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::WebhookInfo do
  let(:instance) { Printful::WebhookInfo.new }

  describe 'test an instance of WebhookInfo' do
    it 'should create an instance of WebhookInfo' do
      expect(instance).to be_instance_of(Printful::WebhookInfo)
    end
  end
