...
# Unit tests for Printful::RetailCosts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::RetailCosts do
  let(:instance) { Printful::RetailCosts.new }

  describe 'test an instance of RetailCosts' do
    it 'should create an instance of RetailCosts' do
      expect(instance).to be_instance_of(Printful::RetailCosts)
    end
  end
