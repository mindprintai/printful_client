...
# Unit tests for Printful::GetProductSizeGuideById404ResponseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetProductSizeGuideById404ResponseError do
  let(:instance) { Printful::GetProductSizeGuideById404ResponseError.new }

  describe 'test an instance of GetProductSizeGuideById404ResponseError' do
    it 'should create an instance of GetProductSizeGuideById404ResponseError' do
      expect(instance).to be_instance_of(Printful::GetProductSizeGuideById404ResponseError)
    end
  end
