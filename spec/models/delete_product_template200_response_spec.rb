...
# Unit tests for Printful::DeleteProductTemplate200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::DeleteProductTemplate200Response do
  let(:instance) { Printful::DeleteProductTemplate200Response.new }

  describe 'test an instance of DeleteProductTemplate200Response' do
    it 'should create an instance of DeleteProductTemplate200Response' do
      expect(instance).to be_instance_of(Printful::DeleteProductTemplate200Response)
    end
  end
