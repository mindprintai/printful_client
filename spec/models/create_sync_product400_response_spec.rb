...
# Unit tests for Printful::CreateSyncProduct400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CreateSyncProduct400Response do
  let(:instance) { Printful::CreateSyncProduct400Response.new }

  describe 'test an instance of CreateSyncProduct400Response' do
    it 'should create an instance of CreateSyncProduct400Response' do
      expect(instance).to be_instance_of(Printful::CreateSyncProduct400Response)
    end
  end
