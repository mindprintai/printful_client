...
# Unit tests for Printful::WarehouseProductVariant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::WarehouseProductVariant do
  let(:instance) { Printful::WarehouseProductVariant.new }

  describe 'test an instance of WarehouseProductVariant' do
    it 'should create an instance of WarehouseProductVariant' do
      expect(instance).to be_instance_of(Printful::WarehouseProductVariant)
    end
  end
