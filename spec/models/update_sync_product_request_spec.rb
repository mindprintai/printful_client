...
# Unit tests for Printful::UpdateSyncProductRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::UpdateSyncProductRequest do
  let(:instance) { Printful::UpdateSyncProductRequest.new }

  describe 'test an instance of UpdateSyncProductRequest' do
    it 'should create an instance of UpdateSyncProductRequest' do
      expect(instance).to be_instance_of(Printful::UpdateSyncProductRequest)
    end
  end
  describe 'test attribute "sync_product"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "sync_variants"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
