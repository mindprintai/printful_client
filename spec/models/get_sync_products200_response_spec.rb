...
# Unit tests for Printful::GetSyncProducts200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetSyncProducts200Response do
  let(:instance) { Printful::GetSyncProducts200Response.new }

  describe 'test an instance of GetSyncProducts200Response' do
    it 'should create an instance of GetSyncProducts200Response' do
      expect(instance).to be_instance_of(Printful::GetSyncProducts200Response)
    end
  end
