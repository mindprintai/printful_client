...
# Unit tests for Printful::Printfile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Printfile do
  let(:instance) { Printful::Printfile.new }

  describe 'test an instance of Printfile' do
    it 'should create an instance of Printfile' do
      expect(instance).to be_instance_of(Printful::Printfile)
    end
  end
  ...
  describe 'test attribute "fill_mode"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cover", "fit"])
      # validator.allowable_values.each do |value|
      #   expect { instance.fill_mode = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "can_rotate"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
