...
# Unit tests for Printful::ItemFilesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ItemFilesInner do
  let(:instance) { Printful::ItemFilesInner.new }

  describe 'test an instance of ItemFilesInner' do
    it 'should create an instance of ItemFilesInner' do
      expect(instance).to be_instance_of(Printful::ItemFilesInner)
    end
  end
  ...
  describe 'test attribute "is_temporary"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
