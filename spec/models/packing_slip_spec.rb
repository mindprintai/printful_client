...
# Unit tests for Printful::PackingSlip
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::PackingSlip do
  let(:instance) { Printful::PackingSlip.new }

  describe 'test an instance of PackingSlip' do
    it 'should create an instance of PackingSlip' do
      expect(instance).to be_instance_of(Printful::PackingSlip)
    end
  end
  ...
  describe 'test attribute "custom_order_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
