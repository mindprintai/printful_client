...
# Unit tests for Printful::AvailabilityStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::AvailabilityStatus do
  let(:instance) { Printful::AvailabilityStatus.new }

  describe 'test an instance of AvailabilityStatus' do
    it 'should create an instance of AvailabilityStatus' do
      expect(instance).to be_instance_of(Printful::AvailabilityStatus)
    end
  end
