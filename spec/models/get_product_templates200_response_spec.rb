...
# Unit tests for Printful::GetProductTemplates200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetProductTemplates200Response do
  let(:instance) { Printful::GetProductTemplates200Response.new }

  describe 'test an instance of GetProductTemplates200Response' do
    it 'should create an instance of GetProductTemplates200Response' do
      expect(instance).to be_instance_of(Printful::GetProductTemplates200Response)
    end
  end
