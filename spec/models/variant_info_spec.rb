...
# Unit tests for Printful::VariantInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::VariantInfo do
  let(:instance) { Printful::VariantInfo.new }

  describe 'test an instance of VariantInfo' do
    it 'should create an instance of VariantInfo' do
      expect(instance).to be_instance_of(Printful::VariantInfo)
    end
  end
