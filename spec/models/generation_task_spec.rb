...
# Unit tests for Printful::GenerationTask
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GenerationTask do
  let(:instance) { Printful::GenerationTask.new }

  describe 'test an instance of GenerationTask' do
    it 'should create an instance of GenerationTask' do
      expect(instance).to be_instance_of(Printful::GenerationTask)
    end
  end
  describe 'test attribute "task_key"' do
    it 'should work' do
  ...
  describe 'test attribute "mockups"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
