...
# Unit tests for Printful::GenerationTaskExtraMockup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GenerationTaskExtraMockup do
  let(:instance) { Printful::GenerationTaskExtraMockup.new }

  describe 'test an instance of GenerationTaskExtraMockup' do
    it 'should create an instance of GenerationTaskExtraMockup' do
      expect(instance).to be_instance_of(Printful::GenerationTaskExtraMockup)
    end
  end
