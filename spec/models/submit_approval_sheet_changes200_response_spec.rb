...
# Unit tests for Printful::SubmitApprovalSheetChanges200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SubmitApprovalSheetChanges200Response do
  let(:instance) { Printful::SubmitApprovalSheetChanges200Response.new }

  describe 'test an instance of SubmitApprovalSheetChanges200Response' do
    it 'should create an instance of SubmitApprovalSheetChanges200Response' do
      expect(instance).to be_instance_of(Printful::SubmitApprovalSheetChanges200Response)
    end
  end
