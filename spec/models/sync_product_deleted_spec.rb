...
# Unit tests for Printful::SyncProductDeleted
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SyncProductDeleted do
  let(:instance) { Printful::SyncProductDeleted.new }

  describe 'test an instance of SyncProductDeleted' do
    it 'should create an instance of SyncProductDeleted' do
      expect(instance).to be_instance_of(Printful::SyncProductDeleted)
    end
  end
