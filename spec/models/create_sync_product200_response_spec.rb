...
# Unit tests for Printful::CreateSyncProduct200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CreateSyncProduct200Response do
  let(:instance) { Printful::CreateSyncProduct200Response.new }

  describe 'test an instance of CreateSyncProduct200Response' do
    it 'should create an instance of CreateSyncProduct200Response' do
      expect(instance).to be_instance_of(Printful::CreateSyncProduct200Response)
    end
  end
