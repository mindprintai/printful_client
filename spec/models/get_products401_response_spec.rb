...
# Unit tests for Printful::GetProducts401Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetProducts401Response do
  let(:instance) { Printful::GetProducts401Response.new }

  describe 'test an instance of GetProducts401Response' do
    it 'should create an instance of GetProducts401Response' do
      expect(instance).to be_instance_of(Printful::GetProducts401Response)
    end
  end
