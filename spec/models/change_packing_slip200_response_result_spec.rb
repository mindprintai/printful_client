...
# Unit tests for Printful::ChangePackingSlip200ResponseResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ChangePackingSlip200ResponseResult do
  let(:instance) { Printful::ChangePackingSlip200ResponseResult.new }

  describe 'test an instance of ChangePackingSlip200ResponseResult' do
    it 'should create an instance of ChangePackingSlip200ResponseResult' do
      expect(instance).to be_instance_of(Printful::ChangePackingSlip200ResponseResult)
    end
  end
