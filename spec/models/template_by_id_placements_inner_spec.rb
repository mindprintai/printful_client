...
# Unit tests for Printful::TemplateByIdPlacementsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TemplateByIdPlacementsInner do
  let(:instance) { Printful::TemplateByIdPlacementsInner.new }

  describe 'test an instance of TemplateByIdPlacementsInner' do
    it 'should create an instance of TemplateByIdPlacementsInner' do
      expect(instance).to be_instance_of(Printful::TemplateByIdPlacementsInner)
    end
  end
  ...
  describe 'test attribute "technique_key"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "technique_display_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
