...
# Unit tests for Printful::OrderEstimateCosts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::OrderEstimateCosts do
  let(:instance) { Printful::OrderEstimateCosts.new }

  describe 'test an instance of OrderEstimateCosts' do
    it 'should create an instance of OrderEstimateCosts' do
      expect(instance).to be_instance_of(Printful::OrderEstimateCosts)
    end
  end
  ...
  describe 'test attribute "digitization"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "additional_fee"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "fulfillment_fee"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
