...
# Unit tests for Printful::GetCategoryById200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetCategoryById200Response do
  let(:instance) { Printful::GetCategoryById200Response.new }

  describe 'test an instance of GetCategoryById200Response' do
    it 'should create an instance of GetCategoryById200Response' do
      expect(instance).to be_instance_of(Printful::GetCategoryById200Response)
    end
  end
