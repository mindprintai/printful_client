...
# Unit tests for Printful::Gift
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Gift do
  let(:instance) { Printful::Gift.new }

  describe 'test an instance of Gift' do
    it 'should create an instance of Gift' do
      expect(instance).to be_instance_of(Printful::Gift)
    end
  end
