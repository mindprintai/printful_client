...
# Unit tests for Printful::ProductInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ProductInfo do
  let(:instance) { Printful::ProductInfo.new }

  describe 'test an instance of ProductInfo' do
    it 'should create an instance of ProductInfo' do
      expect(instance).to be_instance_of(Printful::ProductInfo)
    end
  end
