...
# Unit tests for Printful::CreateGenerationTask
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CreateGenerationTask do
  let(:instance) { Printful::CreateGenerationTask.new }

  describe 'test an instance of CreateGenerationTask' do
    it 'should create an instance of CreateGenerationTask' do
      expect(instance).to be_instance_of(Printful::CreateGenerationTask)
    end
  end
  ...
  describe 'test attribute "format"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["jpg", "png"])
  ...
  describe 'test attribute "option_groups"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "product_template_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
