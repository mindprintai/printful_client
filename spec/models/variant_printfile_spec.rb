...
# Unit tests for Printful::VariantPrintfile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::VariantPrintfile do
  let(:instance) { Printful::VariantPrintfile.new }

  describe 'test an instance of VariantPrintfile' do
    it 'should create an instance of VariantPrintfile' do
      expect(instance).to be_instance_of(Printful::VariantPrintfile)
    end
  end
