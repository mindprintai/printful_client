...
# Unit tests for Printful::GetWebhooks200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetWebhooks200Response do
  let(:instance) { Printful::GetWebhooks200Response.new }

  describe 'test an instance of GetWebhooks200Response' do
    it 'should create an instance of GetWebhooks200Response' do
      expect(instance).to be_instance_of(Printful::GetWebhooks200Response)
    end
  end
