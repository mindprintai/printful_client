...
# Unit tests for Printful::GenerationTaskTemplateFile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GenerationTaskTemplateFile do
  let(:instance) { Printful::GenerationTaskTemplateFile.new }

  describe 'test an instance of GenerationTaskTemplateFile' do
    it 'should create an instance of GenerationTaskTemplateFile' do
      expect(instance).to be_instance_of(Printful::GenerationTaskTemplateFile)
    end
  end
