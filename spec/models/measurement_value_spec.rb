...
# Unit tests for Printful::MeasurementValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::MeasurementValue do
  let(:instance) { Printful::MeasurementValue.new }

  describe 'test an instance of MeasurementValue' do
    it 'should create an instance of MeasurementValue' do
      expect(instance).to be_instance_of(Printful::MeasurementValue)
    end
  end
