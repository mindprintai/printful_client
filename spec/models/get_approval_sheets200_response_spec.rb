...
# Unit tests for Printful::GetApprovalSheets200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetApprovalSheets200Response do
  let(:instance) { Printful::GetApprovalSheets200Response.new }

  describe 'test an instance of GetApprovalSheets200Response' do
    it 'should create an instance of GetApprovalSheets200Response' do
      expect(instance).to be_instance_of(Printful::GetApprovalSheets200Response)
    end
  end
