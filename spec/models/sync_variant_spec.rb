...
# Unit tests for Printful::SyncVariant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SyncVariant do
  let(:instance) { Printful::SyncVariant.new }

  describe 'test an instance of SyncVariant' do
    it 'should create an instance of SyncVariant' do
      expect(instance).to be_instance_of(Printful::SyncVariant)
    end
  end
