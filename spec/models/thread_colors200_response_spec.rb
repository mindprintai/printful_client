...
# Unit tests for Printful::ThreadColors200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ThreadColors200Response do
  let(:instance) { Printful::ThreadColors200Response.new }

  describe 'test an instance of ThreadColors200Response' do
    it 'should create an instance of ThreadColors200Response' do
      expect(instance).to be_instance_of(Printful::ThreadColors200Response)
    end
  end
  ...
  describe 'test attribute "thread_colors"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
