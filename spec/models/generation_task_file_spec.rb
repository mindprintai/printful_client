...
# Unit tests for Printful::GenerationTaskFile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GenerationTaskFile do
  let(:instance) { Printful::GenerationTaskFile.new }

  describe 'test an instance of GenerationTaskFile' do
    it 'should create an instance of GenerationTaskFile' do
      expect(instance).to be_instance_of(Printful::GenerationTaskFile)
    end
  end
