...
# Unit tests for Printful::TemplateVariantMapping
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TemplateVariantMapping do
  let(:instance) { Printful::TemplateVariantMapping.new }

  describe 'test an instance of TemplateVariantMapping' do
    it 'should create an instance of TemplateVariantMapping' do
      expect(instance).to be_instance_of(Printful::TemplateVariantMapping)
    end
  end
