...
# Unit tests for Printful::Measurement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Measurement do
  let(:instance) { Printful::Measurement.new }

  describe 'test an instance of Measurement' do
    it 'should create an instance of Measurement' do
      expect(instance).to be_instance_of(Printful::Measurement)
    end
  end
