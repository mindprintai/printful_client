...
# Unit tests for Printful::SizeTable
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::SizeTable do
  let(:instance) { Printful::SizeTable.new }

  describe 'test an instance of SizeTable' do
    it 'should create an instance of SizeTable' do
      expect(instance).to be_instance_of(Printful::SizeTable)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["measure_yourself", "product_measure", "international"])
  ...
  describe 'test attribute "unit"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["inches", "cm"])
      # validator.allowable_values.each do |value|
