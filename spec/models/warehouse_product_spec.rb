...
# Unit tests for Printful::WarehouseProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::WarehouseProduct do
  let(:instance) { Printful::WarehouseProduct.new }

  describe 'test an instance of WarehouseProduct' do
    it 'should create an instance of WarehouseProduct' do
      expect(instance).to be_instance_of(Printful::WarehouseProduct)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["created", "active", "suspended", "declined", "draft"])
