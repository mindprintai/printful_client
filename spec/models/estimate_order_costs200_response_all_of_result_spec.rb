...
# Unit tests for Printful::EstimateOrderCosts200ResponseAllOfResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::EstimateOrderCosts200ResponseAllOfResult do
  let(:instance) { Printful::EstimateOrderCosts200ResponseAllOfResult.new }

  describe 'test an instance of EstimateOrderCosts200ResponseAllOfResult' do
    it 'should create an instance of EstimateOrderCosts200ResponseAllOfResult' do
      expect(instance).to be_instance_of(Printful::EstimateOrderCosts200ResponseAllOfResult)
    end
  end
  ...
  describe 'test attribute "retail_costs"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
