...
# Unit tests for Printful::GetTaxCountries200ResponseResultInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetTaxCountries200ResponseResultInner do
  let(:instance) { Printful::GetTaxCountries200ResponseResultInner.new }

  describe 'test an instance of GetTaxCountries200ResponseResultInner' do
    it 'should create an instance of GetTaxCountries200ResponseResultInner' do
      expect(instance).to be_instance_of(Printful::GetTaxCountries200ResponseResultInner)
    end
  end
