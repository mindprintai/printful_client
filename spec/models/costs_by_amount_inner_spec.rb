...
# Unit tests for Printful::CostsByAmountInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CostsByAmountInner do
  let(:instance) { Printful::CostsByAmountInner.new }

  describe 'test an instance of CostsByAmountInner' do
    it 'should create an instance of CostsByAmountInner' do
      expect(instance).to be_instance_of(Printful::CostsByAmountInner)
    end
  end
