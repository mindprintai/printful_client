...
# Unit tests for Printful::OrderCosts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::OrderCosts do
  let(:instance) { Printful::OrderCosts.new }

  describe 'test an instance of OrderCosts' do
    it 'should create an instance of OrderCosts' do
      expect(instance).to be_instance_of(Printful::OrderCosts)
    end
  end
  ...
  describe 'test attribute "retail_delivery_fee"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
