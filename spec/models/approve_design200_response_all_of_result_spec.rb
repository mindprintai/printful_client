...
# Unit tests for Printful::ApproveDesign200ResponseAllOfResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ApproveDesign200ResponseAllOfResult do
  let(:instance) { Printful::ApproveDesign200ResponseAllOfResult.new }

  describe 'test an instance of ApproveDesign200ResponseAllOfResult' do
    it 'should create an instance of ApproveDesign200ResponseAllOfResult' do
      expect(instance).to be_instance_of(Printful::ApproveDesign200ResponseAllOfResult)
    end
  end
