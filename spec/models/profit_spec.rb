...
# Unit tests for Printful::Profit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Profit do
  let(:instance) { Printful::Profit.new }

  describe 'test an instance of Profit' do
    it 'should create an instance of Profit' do
      expect(instance).to be_instance_of(Printful::Profit)
    end
  end
