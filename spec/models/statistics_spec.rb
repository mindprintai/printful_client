...
# Unit tests for Printful::Statistics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::Statistics do
  let(:instance) { Printful::Statistics.new }

  describe 'test an instance of Statistics' do
    it 'should create an instance of Statistics' do
      expect(instance).to be_instance_of(Printful::Statistics)
    end
  end
  describe 'test attribute "store_statistics"' do
    it 'should work' do
