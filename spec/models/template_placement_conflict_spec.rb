...
# Unit tests for Printful::TemplatePlacementConflict
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::TemplatePlacementConflict do
  let(:instance) { Printful::TemplatePlacementConflict.new }

  describe 'test an instance of TemplatePlacementConflict' do
    it 'should create an instance of TemplatePlacementConflict' do
      expect(instance).to be_instance_of(Printful::TemplatePlacementConflict)
    end
  end
