...
# Unit tests for Printful::DeleteProductTemplate200ResponseAllOfResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::DeleteProductTemplate200ResponseAllOfResult do
  let(:instance) { Printful::DeleteProductTemplate200ResponseAllOfResult.new }

  describe 'test an instance of DeleteProductTemplate200ResponseAllOfResult' do
    it 'should create an instance of DeleteProductTemplate200ResponseAllOfResult' do
      expect(instance).to be_instance_of(Printful::DeleteProductTemplate200ResponseAllOfResult)
    end
  end
