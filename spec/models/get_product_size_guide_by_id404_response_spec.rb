...
# Unit tests for Printful::GetProductSizeGuideById404Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetProductSizeGuideById404Response do
  let(:instance) { Printful::GetProductSizeGuideById404Response.new }

  describe 'test an instance of GetProductSizeGuideById404Response' do
    it 'should create an instance of GetProductSizeGuideById404Response' do
      expect(instance).to be_instance_of(Printful::GetProductSizeGuideById404Response)
    end
  end
