...
# Unit tests for Printful::GetStatistics200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetStatistics200Response do
  let(:instance) { Printful::GetStatistics200Response.new }

  describe 'test an instance of GetStatistics200Response' do
    it 'should create an instance of GetStatistics200Response' do
      expect(instance).to be_instance_of(Printful::GetStatistics200Response)
    end
  end
