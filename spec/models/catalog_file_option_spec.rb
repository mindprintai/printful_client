...
# Unit tests for Printful::CatalogFileOption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::CatalogFileOption do
  let(:instance) { Printful::CatalogFileOption.new }

  describe 'test an instance of CatalogFileOption' do
    it 'should create an instance of CatalogFileOption' do
      expect(instance).to be_instance_of(Printful::CatalogFileOption)
    end
  end
