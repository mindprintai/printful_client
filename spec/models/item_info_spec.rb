...
# Unit tests for Printful::ItemInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::ItemInfo do
  let(:instance) { Printful::ItemInfo.new }

  describe 'test an instance of ItemInfo' do
    it 'should create an instance of ItemInfo' do
      expect(instance).to be_instance_of(Printful::ItemInfo)
    end
  end
