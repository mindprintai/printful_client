...
# Unit tests for Printful::OrderEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::OrderEvent do
  let(:instance) { Printful::OrderEvent.new }

  describe 'test an instance of OrderEvent' do
    it 'should create an instance of OrderEvent' do
      expect(instance).to be_instance_of(Printful::OrderEvent)
    end
  end
  ...
  describe 'test attribute "branding_items"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "incomplete_items"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
