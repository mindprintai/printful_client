...
# Unit tests for Printful::GetProductById200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Printful::GetProductById200Response do
  let(:instance) { Printful::GetProductById200Response.new }

  describe 'test an instance of GetProductById200Response' do
    it 'should create an instance of GetProductById200Response' do
      expect(instance).to be_instance_of(Printful::GetProductById200Response)
    end
  end
